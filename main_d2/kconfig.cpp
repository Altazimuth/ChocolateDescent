...
extern uint8_t CybermouseActive;
...
uint8_t				kc_enable_external_control = 0;
...
{
	Warning("kconfig_init_external_controls: I'm sorry, but I regret to inform you it isn't 1996 anymore. Don't call me\n");
}
...
void controls_read_all()
{
	...
	//if (kc_use_external_control || CybermouseActive) //[ISB] not 1996
...
{
	Warning("ISB, you didn't heed my (ISB's) advice and called kconfig_read_external_controls.\n");
}
#endif
